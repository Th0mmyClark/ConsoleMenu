...
In short, when you submit code changes, your submissions are understood to be under the same [MS-PL License](https://opensource.org/license/ms-pl-html/) that covers the project. Feel free to contact the maintainers if that's a concern.

## Report bugs using Github's [issues](https://github.com/Th0mmyClark/ConsoleMenu/issues)
...
This contribution guideline was borrowed [here](https://gist.github.com/briandk/3d2e8b3ec8daf5a27a62)
